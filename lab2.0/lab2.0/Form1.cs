...
namespace lab2._0
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            Point c = new Point();
            c.X = e.X; c.Y = e.Y;
            Point p1 = new Point(c.X - 100, c.Y);
            Point p2 = new Point(c.X, c.Y - 150);
            Point p3 = new Point(c.X + 100, c.Y);
            Point p4 = new Point(c.X, c.Y + 150);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)//вызываем диалоговое окно и проверяем выбран ли файл
            {
                ...
                bmp = new Bitmap(image); //создаем и загружаем из image изображение в форматье bm
